...
-- Дамп структуры для таблица test_wp.wp_users
...
-- Дамп данных таблицы test_wp.wp_users: ~1 rows (приблизительно)
...
REPLACE INTO `wp_users` (`ID`, `user_login`, `user_pass`, `user_nicename`, `user_email`, `user_url`, `user_registered`, `user_activation_key`, `user_status`, `display_name`) VALUES
	(1, 'admin', '$P$BACEPu.gCPynferzl06I56I4sXki4W.', 'admin', 'admin@admin.com', '', '2014-01-13 08:56:01', '', 0, 'admin');
